...
def wordform_get_all() -> Generator:
    ...
    #     yield wordform
    raise NotImplementedError("FLEx API integration required")


def wordform_create(form: str, ws_handle: Union[str, int]) -> object:
    """
...
def wordform_exists(form: str, ws_handle: Union[str, int]) -> bool:
    """
...
def wordform_find(form: str, ws_handle: Union[str, int]) -> Optional[object]:
    """
