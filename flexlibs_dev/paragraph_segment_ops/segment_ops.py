...
def segment_get_all(paragraph_or_hvo: Optional[Union[Any, int]] = None) -> Generator[Any, None, None]:
    """
...
def segment_get_analyses(segment_or_hvo: Union[Any, int]) -> List[Any]:
    """
    ...
    if isinstance(segment_or_hvo, int):
        # TODO: Get segment from cache using HVO
        pass
...
def segment_get_notes(segment_or_hvo: Union[Any, int]) -> List[Any]:
    """
