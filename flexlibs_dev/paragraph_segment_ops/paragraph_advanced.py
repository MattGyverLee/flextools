...
def paragraph_get_translations(para_or_hvo: Union[Any, int]) -> Dict[str, str]:
    """
...
def paragraph_get_notes(para_or_hvo: Union[Any, int]) -> List[Any]:
    """
...
def paragraph_get_style_name(para_or_hvo: Union[Any, int]) -> str:
    """
